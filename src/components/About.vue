<template>
<div class="container mx-auto text-center lg:w-1/3 md:w-1/2 md:px-0 px-4">
  <div class="inline-flex justify-center w-full items-center mb-8">
    <img src="../assets/img/about/donut.svg" alt="donut" class="w-auto h-12">
    <h2 class="uppercase text-4xl mb-4 ml-4">festivalu</h2>
  </div>
  <article>
  ...
  <button class="mt-4 font-bold inline-flex items-center text-red text-lg focus:outline-none">
    Minulé ročníky
    <span>
